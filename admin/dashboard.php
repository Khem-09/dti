...
<body style="background-color: #EAEAEA; overflow-x: hidden;">
    ...
    <div class="offcanvas offcanvas-start d-md-none" tabindex="-1" id="mobileSidebar" style="background-color: #0A0A3A; width: 280px;">
        ...
        <div class="offcanvas-body px-2 py-4">
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link active py-3 fw-bold" href="dashboard.php" style="background-color: rgba(255,255,255,0.1); border-left: 4px solid white; color: white;">
    ...
    <div class="modal fade" id="adminManageUserModal" tabindex="-1" aria-hidden="true" style="z-index: 1055;">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content" style="border-radius: 12px; background-color: #f4f6f9;">
                <div class="modal-header border-0 pb-0 px-4 pt-4">
                    <div>
                        <h4 class="modal-title fw-bold" style="color: #0A0A3A;"><i class="bi bi-person-gear me-2"></i>Manage Admin Users</h4>
                        <p class="text-secondary small mb-0">Add, edit, or remove admin accounts with access to the dashboard</p>
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                        ...
                        <div class="table-responsive border rounded shadow-sm">
                            <table class="table table-hover align-middle mb-0 text-nowrap">
                                ...
                                <tbody id="adminUsersTableBody">
                                    <!-- Admin users will be dynamically loaded here via JavaScript -->
                                </tbody>
                            </table>
                        </div>
                </div>
    ...
    <script>
        ...
        function updateAdminPassword(e) {
            ...
            showConfirmModal('Update Password', 'Are you sure you want to change your password? You will be securely logged out after.', 'primary', '<i class="bi bi-shield-lock"></i> Update', async function() {
